...
\subsubsection{Run Fight Repeat \aux{\href{https://apps.apple.com/us/app/run-fight-repeat/id6744827856}{Link \linkicon}}}
\begin{itemize}
  \item Designed and implemented the entire runner mechanics, including dynamic level generation, obstacle placement, and pathfinding for smooth player progression.
  \item Developed upgrade and progression systems, allowing players to enhance their characters and abilities through strategic resource management.
  \item Implemented robust state management systems to ensure seamless transitions between runner, battle, and upgrade phases.
\end{itemize}
...
\begin{itemize} \item Actively contributed to debugging and QA processes by identifying, documenting, and verifying gameplay and UI-related issues across multiple test builds.
\item Collaborated with developers to ensure timely bug fixes, providing reproduction cases and verifying post-fix stability in daily builds. \end{itemize}

\subsubsection{Smith Journey \aux{\href{https://apps.apple.com/us/app/smith-journey/id6741895744}{Link \linkicon}}}
\begin{itemize} \item Supported the team by conducting focused playtesting sessions, helping identify edge-case bugs and inconsistencies in game progression.
\item Assisted in troubleshooting and regression testing during sprint deliveries, ensuring clean handoff of builds for submission. \end{itemize}
